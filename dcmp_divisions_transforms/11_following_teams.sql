CREATE TABLE IF NOT EXISTS following_teams AS (
    ...
    ranked_following_teams AS (
        ...
        LEFT JOIN event_states ON teams_to_pass.district_key = event_states.district_key AND event_states.event_type = 'District Championship Division'
