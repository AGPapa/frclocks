CREATE TABLE IF NOT EXISTS district_rankings_without_impact AS (
    SELECT
        ...
        adjusted_district_rankings.region,
        ...
        ROW_NUMBER() OVER (PARTITION BY adjusted_district_rankings.district_key, adjusted_district_rankings.region ORDER BY adjusted_district_rankings.inflated_points DESC, adjusted_district_rankings.rank ASC) AS active_team_rank
